...
public class SensorContext extends Activity implements SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sensor_context);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_sensor_context, menu);
        return true;
    }
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (mySensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            //Log.d("Ole", "Vamooos" + x + " "+y+" "+z+"SEFINI" );
            last_x = getX();
            last_y = getY();
            last_z = getZ();
        }
